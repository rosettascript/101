...
const values = [
  {
    icon: Zap,
    title: "Simplicity",
    description: "We believe developer tools should be simple and intuitive. No steep learning curves, just solutions that work.",
    color: "text-primary",
  },
  {
    icon: Target,
    title: "Efficiency",
    description: "Every tool we build is designed to save you time. Focus on building, not configuring.",
    color: "text-secondary",
  },
  {
    icon: Heart,
    title: "Community",
    description: "We're developers helping developers. All our tools are free to use and many are open source.",
    color: "text-accent",
  },
];
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            ...
            tasks. We build tools that let you focus on what matters—creating amazing software.
          </p>
        </div>
        ...
        <div className="terminal-bg p-8 mb-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              We're on a mission to democratize developer tools. Whether you're a student working on 
              your first project or a seasoned developer automating workflows, RosettaScript provides 
              the tools you need—completely free.
            </p>
            <p className="text-muted-foreground">
              Our tools range from simple converters to complex database managers, all designed with 
              the same philosophy: powerful functionality with a clean, intuitive interface.
            </p>
          </div>
        </div>
